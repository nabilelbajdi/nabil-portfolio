        ...
        >
          ...
          <div className="space-y-4 mono text-sm">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-0">
              ...
              <span className="text-[var(--v2-text-muted)] hidden sm:inline">:</span>
              <span className="sm:ml-2 text-green-400">"Open to opportunities"</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          {socialLinks.map((link) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 text-[var(--v2-text-muted)] hover:text-[var(--v2-accent)] hover:bg-[var(--v2-bg-tertiary)] rounded-lg transition-all"

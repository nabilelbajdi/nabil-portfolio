      ...
      <div className="container mx-auto relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 px-4">
          {skillCategories.map((category, index) => (
            <div 
              key={index}
              className="bg-white dark:bg-zinc-900/90 rounded-2xl p-5 border border-border shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-in opacity-0 relative z-40"
